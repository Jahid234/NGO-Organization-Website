<?php
// sender details
$sender_email = 'jahid1213cvgc@gmail.com';   // enter your own email here
$organization = 'NEUB Foundation';
$sender_pwd = 'xxicbhydyhoxynbl';   // please enter password here for the email provided above
...
// from address
$mail->setFrom($sender_email, $organization);
...
$mail->AddReplyTo($sender_email, $organization);
...
$mail->Subject = 'Email Verification from NEUB Foundation';
